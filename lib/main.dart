...
import 'package:project_anggun_fania/Email.dart';
import 'package:project_anggun_fania/Instagram.dart';
import 'package:project_anggun_fania/WhatsApp.dart';

void main() => runApp(MyApp());

class MyApp extends StatelessWidget {
  List<String> tags = ['WhatsApp Tes','Email','Instagram',];
            ...
            Row(
              children: <Widget>[
                Padding(
                  ...
                  child: CircleAvatar(
                    radius: 30,
                    backgroundImage: AssetImage('jpg/anggun.jpg'),
                  ),
                ),
                Padding(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                  ...
                                  child: Text(
                                    'Sumatra Selatan, Palembang, Basuki Rahmat ',
                                    style: TextStyle(
              ...
              child: Card(
                child: Container(
                  ...
                  child: Text ('Biodata Mahasiswa', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 24,color: Colors.black)),
                    ...
                    Text( 'Nama       : Anggun Fania', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)
                        )
                      ]
                    ),
                      ),
                    ...
                    children: <Widget>[
                      Icon(Icons.dialpad),
                   Text('NPM        : 021200049', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)
                          )
                        ]
                        ),
                      ),
                   ...
                   Text('TTL          : Palembang, 27 Febuari 2001', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)
                          )
                        ]
                      ),
                    ),
                    ...
                    Text('E-mail      : anggunfania113@gmal.com', style: TextStyle(fontWeight: FontWeight.bold, fontSize:18)
                         )
                       ]
                      ),
                    ),
                    ...
                    Text('Telepon   : 082371449584', style: TextStyle(fontWeight: FontWeight.bold ,fontSize: 18)
                          )
                        ]
                      ),
                    ),
                    ...
                    children: <Widget>[
                      Icon(Icons.home),
                    Text('Alamat    : Palembang', style: TextStyle(fontWeight: FontWeight.bold ,fontSize: 18)
                          )
                         ]
                       ),
                      ),
